...
def test_axiparabola():
    ...
    laser.propagate( -2*ZR ) # Propagate to two Rayleigh lengths before the middle of the focal range
    ...
    laser.propagate( 4*ZR ) # Propagate to two Rayleigh lengths after the middle of the focal range
