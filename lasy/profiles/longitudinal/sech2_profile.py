...
class Sech2Profile(LongitudinalProfile):
    r"""
    Class for the analytic profile of a longitudinally sech^2 laser pulse.
    ...
    tau : float (in second)
        ...
        formula. Note that :math:`\tau = \tau_{FWHM}/{2 \arccosh{\sqrt{2}}}`,
