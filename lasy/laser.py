...
class Laser:
    ...
    def propagate(self, distance, nr_boundary=None, backend="NP"):
        ...
        field_fft = np.fft.fft(self.field.array, axis=time_axis_indx, norm="forward")
