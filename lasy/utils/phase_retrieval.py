...
def gerchberg_saxton_algo(laserPos1,laserPos2,dz,condition='max_itterations',max_itterations=10,amplitude_error=1.0,debug=False):
    """
    ...
    while breakout(cond):
        ...
        if debug:
            i +=1
            print('Itteration %i : Amplitude Error (summed) = %.2e' %(i,amp_error_summed/amp1_summed))
        if condition == 'max_itterations':
            cond += 1
        else:
